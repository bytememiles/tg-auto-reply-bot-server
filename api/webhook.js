...
const KEYWORD_REPLIES = {
  dog: "Hey, idiot!",
  idiot: "Keep it civil please.",
  stupid: "No need for that.",
  dumb: "Let's keep the chat clean.",
  "shut up": "Be nice.",
  stfu: "Be nice.",
  loser: "Chill.",
  ...
  wtf: "Easy there.",
  wtff: "Easy there.",
  bs: "Let's keep it constructive.",
  bullshit: "Let's keep it constructive.",
  hate: "No hate here please.",
  "kill yourself": "Not cool. Be kind.",
  kys: "Not cool. Be kind.",
  shit: "Language.",
  shitty: "Language.",
  fuck: "Keep it clean please.",
  fucking: "Keep it clean please.",
  fck: "Keep it clean please.",
  fcking: "Keep it clean please.",
  fuk: "Keep it clean please.",
  damn: "Easy on the language.",
  hell: "Let's keep it friendly.",
  asshole: "Be nice.",
  bitch: "Keep it civil.",
  piss: "Language.",
  "piss off": "Chill.",
